/// @description Draw the HUD
	...
	if (!instance_exists(obj_bonus_level)) {
		...
		//Draw number
		draw_text(125 + offset[0], 9, string(global.score));
		draw_text(125 + offset[1], 25, string(minute)+" "+(sec > 9 ? "" : "0") + string(sec)+" "+(milsec > 9 ? "" : "0") + string(milsec));
		draw_text(125 + offset[2], 41, string(global.rings));
