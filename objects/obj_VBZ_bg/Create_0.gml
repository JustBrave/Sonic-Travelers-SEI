/// @description Add background
	...
	add_background(spr_bg_VBZ_bushtest, 2, 1, v_scroll, 0, 0, 0, 0);
	add_background(spr_bg_VBZ_bushtest, 1, 1, v_scroll, 0, 0, 0, 100);
	add_background(spr_bg_VBZ_bushtest, 3, 1, v_scroll, 0, 0, 0, 224);
	add_background(spr_bg_aaz_bottom, 2, 0.84, v_scroll, 0, 0, 0, 144);
	add_background(spr_bg_aaz_bottom, 1, 0.78, v_scroll, 0, 0, 0, 144);
	add_background(spr_bg_VBZ_bushtest, 0, 0.72, v_scroll, 0, 0, 0, 314);
