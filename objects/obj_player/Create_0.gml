/// @description Values
	...
	//Physics values
	x_accel = 0.046875;					//Value used for player's horizotntal acceleration
	x_deaccel = 0.5;
	y_accel = 0.21875;					//Value used for player's vertical gra, specifically gravirt
	...
	max_speed = 25;						//Player's horizontal speed cap
	...
	skid_timer = 1;						//Timer that is used to cancel the skid when input is not being held
	...
	speed_shoes_flag = false;			//Check used to check if player has speed shoes or nots
