/// @description Script
	...
	{
		//Slow down normally
		spin_speed = max(spin_speed - 0.42, 4);
	...
	//Screen sides bounce
	if(x < obj_camera.limit_left + 20 && x_speed < 0 || x > obj_camera.limit_right - 20 && x_speed > 0)
	{
		x_speed *= -1;
	}
	var monitor = noone;
